 ...
 * @author ferna
 */
public class ProducaoPrincipalView extends javax.swing.JFrame {

    /**
     * Creates new form CadastroPrincipalView
     */
    public ProducaoPrincipalView() {
        ImageIcon icon = new ImageIcon("src/midia/logo-modulo-producao.png");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProducaoPrincipalView().setVisible(true);
            }
        });
    }
