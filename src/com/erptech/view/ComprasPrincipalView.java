 ...
 * @author ferna
 */
public class ComprasPrincipalView extends javax.swing.JFrame {

    /**
     * Creates new form CadastroPrincipalView
     */
    public ComprasPrincipalView() {
        ImageIcon icon = new ImageIcon("src/midia/logo-modulo-compras.png");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ComprasPrincipalView().setVisible(true);
            }
        });
    }
