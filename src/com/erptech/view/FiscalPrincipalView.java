 ...
 * @author ferna
 */
public class FiscalPrincipalView extends javax.swing.JFrame {

    /**
     * Creates new form CadastroPrincipalView
     */
    public FiscalPrincipalView() {
        ImageIcon icon = new ImageIcon("src/midia/logo-modulo-fiscal.png");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FiscalPrincipalView().setVisible(true);
            }
        });
    }
