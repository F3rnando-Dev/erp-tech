 ...
 * @author ferna
 */
public class SuportePrincipalView extends javax.swing.JFrame {

    /**
     * Creates new form CadastroPrincipalView
     */
    public SuportePrincipalView() {
        ImageIcon icon = new ImageIcon("src/midia/logo-modulo-suporte.png");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SuportePrincipalView().setVisible(true);
            }
        });
    }
