 ...
 * @author ferna
 */
public class QualidadePrincipalView extends javax.swing.JFrame {

    /**
     * Creates new form CadastroPrincipalView
     */
    public QualidadePrincipalView() {
        ImageIcon icon = new ImageIcon("src/midia/logo-modulo-controle-de-qualidade.png");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QualidadePrincipalView().setVisible(true);
            }
        });
    }
