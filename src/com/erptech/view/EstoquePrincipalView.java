 ...
 * @author ferna
 */
public class EstoquePrincipalView extends javax.swing.JFrame {

    /**
     * Creates new form CadastroPrincipalView
     */
    public EstoquePrincipalView() {
        ImageIcon icon = new ImageIcon("src/midia/logo-modulo-estoque.png");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EstoquePrincipalView().setVisible(true);
            }
        });
    }
